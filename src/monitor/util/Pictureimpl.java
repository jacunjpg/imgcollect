...
public class Pictureimpl {
	...
	public static void main(String[] args){
		creatbulider(null,null,null,null,null);
	 ...
	 * @return 
	 */
	public static MultipartEntityBuilder creatbulider(String type,String id,String image,File imagesetfile,String[] cbks)
	{
	 ...
	 * @return
	 */
	public CloseableHttpClient initHttpClient(String ip,String impl,int time) {
		// 设置请求和传输超时时间
