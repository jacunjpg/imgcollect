...
public class SignatureAndVerify4 {
	public static String RIVATE_KEY = "pem\\pkcs8_private_key.pem";
	public static String TUPU_PUBLIC_KEY = "pem\\open_tuputech_com_public_key.pem";
	 ...
	 * 
	 **/
	public static String Signature(String sign_string,String path_local) {
		try {
			// 读取你的密钥pkcs8_private_key.pem
			File private_key_pem = new File(path_local+"\\WEB-INF\\classes\\"+RIVATE_KEY);
	 ...
	 * 
	 **/
	public static boolean Verify(String signature, String json ,String path_local) {
		try {
			// 读取图普公钥open_tuputech_com_public_key.pem
			File open_tuputech_com_public_key_pem = new File(path_local+"\\WEB-INF\\classes\\"+TUPU_PUBLIC_KEY);
