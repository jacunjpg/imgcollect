...
public class Picturedraw{  
    ...
    public static void main(String[] args)throws Exception{  
        Picturedraw imageObj = new Picturedraw();  
        ...
        */  
        ...
        //"x":114,"y":60,"width":71,"height":71
        String srcImagePath = "E:/fakezip/2.jpg";
        String toPath = "E:/fakezip/3.jpg"; 
        String imageFormat = "jpg"; 
        int x = 431; 
        int y = 499; 
        int width = 78; 
        int height = 78; 
        Color lineColor = Color.RED; 
        imageObj.drawRectangle(srcImagePath, x, y, width, height, lineColor,toPath, imageFormat);
     ...
     * @throws IOException   
     */  
	public void drawRectangle(String srcImagePath, int x, int y, int width,
			int height, Color lineColor, String toPath, String imageFormat) throws IOException {
